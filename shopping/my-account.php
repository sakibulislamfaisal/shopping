...
<div class="panel panel-default checkout-step-01">
	...
	<!-- panel-heading -->
    	...
    	<h4 class="unicase-checkout-title">
	        <a data-toggle="collapse" class="" data-parent="#accordion" href="#collapseOne">
	          <span>1</span>User Profile Information
	        </a>
	     </h4>
    </div>
    <!-- panel-heading -->
	...
	<div id="collapseOne" class="panel-collapse collapse in">
	    ...
	    <div class="panel-body">
			<div class="row">		
<h3 style="font-size:26px; text-align:center; text-decoration:underline">Personal Information</h3>
...
<div class="form-group">
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <button type="submit" name="update" class="btn-upper btn btn-success checkout-page-button">Update User-Info</button>
					</form>
					<?php } ?>
				</div>	
...
<div class="form-group">
			 ...
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  ...
					  <button type="submit" name="submit" class="btn-upper btn btn-success checkout-page-button">Change Password</button>
					</form> 
