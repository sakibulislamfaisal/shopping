								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="favorite-button m-t-10">
											<a class="btn btn-danger" data-toggle="tooltip" data-placement="right" title="Wishlist" href="product-details.php?pid=<?php echo htmlentities($row['id']) ?>&&action=wishlist">
...
<section class="section featured-product wow fadeInUp">
	<h3 class="section-title relate">Related Products </h3>
