...
{
    ?>
                <a href="sub-category.php?scid=<?php echo $row['id'];?>" class="dropdown-toggle"><i class="icon fa fa-check-square"></i>
...
<!-- ================================== TOP NAVIGATION : END ================================== -->	            <div class="sidebar-module-container sidebar ">
	            	<h5 class="section-title">Shopping Categories</h5>
		...
		<div class="accordion">
	    	<div class="accordion-group">
	            <div class="accordion-heading">
	                <a href="category.php?cid=<?php echo $row['id'];?>"  class="accordion-toggle collapsed"> <i class="icon fa fa-check-square"></i>
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
							...
							<button class="btn btn-success btn-md" type="button">Add to cart</button></a>
