...
<div class="col-md-4 col-sm-12 cart-shopping-total">
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							...
							<!-- <a  style="font-size:17px;text-transform:uppercase;letter-spacing:2px;" href="checkout.php?price=<?php echo $totalprice?>" class="btn btn-success btn-lg">Proceed To Checkout</a> -->
							<!-- <button type="submi style="font-size:17px;text-transform:uppercase;letter-spacing:2px;" href="checkout.php?price=<?php echo $totalprice?>" class="btn btn-success btn-lg">Proceed To Checkout</button> -->
	...
	<?php } else {
	echo "<span style='color:red; font-size:20px'>Welcome to Our Online Shopping System. You Can Enjoy Your Shopping With Us. </span>";
		}?>
</div>			</div>
		</div> 
		</form>
