...
?>
		...
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1">Contact no </label>
		 <input type="text" name="contact" class="form-control unicase-form-control text-input" id="contact-forget" required>
		</div>
<div class="form-group">
...
<div class="form-group">
	  	...
	  	<button type="submit" class="btn-upper btn btn-success checkout-page-button" name="change">Generate New Password</button>
	</form>					
</div>
<!-- Sign-in -->
