...
<div class="logo">
	<a href="index.php">
		...
		<h2 style="color:white;font-weight:500">SMART BAZAR</h2>
...
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">
            ...
            <input class="search-field" placeholder="Search Your Products...." name="product" required="required" />
...
if(!empty($_SESSION['cart'])){
	...
	?>
			...
			<div class="clearfix cart-total">
				...
				<a href="my-cart.php" class="btn btn-upper btn-info btn-block m-t-20">My Cart</a>	
			</div><!-- /.cart-total-->
...
<div class="dropdown dropdown-cart">
		...
		<ul class="dropdown-menu">
			...
			<div class="clearfix cart-total">
				...
				<a href="index.php" class="btn btn-upper btn-info btn-block m-t-20">Continue Shopping</a>	
			</div><!-- /.cart-total-->
