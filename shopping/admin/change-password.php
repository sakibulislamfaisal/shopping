					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h4 class="admin-head">Admin Change Password</h4>
							</div>
...
<div class="controls">
<input type="password" placeholder="Enter your confirm new password"  name="confirmpassword" class="span8 tip" required>
</div>
</div>

<div class="control">
	<div class="controls">
		<button type="submit" name="submit" class="btn btn-success admin-btn">Get Password</button> 
	</div>
</div>
</form>
</div>
