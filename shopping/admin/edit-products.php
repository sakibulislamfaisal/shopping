...
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Enter Price Before Discount" value="<?php echo htmlentities($row['productPriceBeforeDiscount']);?>"  class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Product Price After Discount</label>
<div class="controls">
...
<?php } ?>
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn btn-success admin-btn">Update</button>
											</div>
										</div>
									</form>
							</div>
