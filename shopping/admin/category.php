...
<div class="control-group">
											...
											<div class="controls">
												<textarea class="span8"  name="description" rows="5" placeholder="Write description here..."></textarea>
											</div>
										</div>

	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn btn-success admin-btn">Add Category</button>
											</div>
										</div>
									</form>
							</div>
