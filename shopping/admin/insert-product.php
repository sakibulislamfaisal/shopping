...
<!-- 
<div class="control-group">
<label class="control-label" for="basicinput">Select SubCategory</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Select Sub Category</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput"> Price Before Discount</label>
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Enter Product Price Before Discount" class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput"> Price After Discount</label>
<div class="controls">
<input type="text"    name="productprice"  placeholder="Enter Product Price After Discount" class="span8 tip" required>
</div>
</div>
...
<input type="file" name="productimage3"  class="span8 tip">
	...
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn btn-success admin-btn">Add Product</button>
											</div>
										</div>
									</form>
							</div>
