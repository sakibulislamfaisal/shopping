...
?>
				<tr>
					<td><?php echo $cnt;?></td>
					<!-- <td class="cart-image">
						<a class="entry-thumbnail" href="index.php">
						    <img src="admin/productimages/<?php echo $row['pname'];?>/<?php echo $row['pimg1'];?>" alt="" width="84" height="120">
						</a>
					</td> -->
					...
					<td>
 <a href="javascript:void(0);" onClick="popUpWindow('track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Track order" style="font-size:16px;color:black">
					Track</td>
				</tr>
<?php $cnt=$cnt+1;} } else { ?>
